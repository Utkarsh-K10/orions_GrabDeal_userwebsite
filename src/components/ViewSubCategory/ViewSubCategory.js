...
const ViewSubCategory = () => {
  ...
  // const url = `${process.env.REACT_APP_USER_API}/category/subcategory/show`;
  const url = `${process.env.REACT_APP_USER_API}/category/${productId}`;
  ...
  const CategoryElements = () => {
    return data.subCategory.map((category) => {
      return (
          ...
          <div className="card1 card-view m-3">
            <div className="card-block">
              ...
              <div className="p-3 card__info">
                <h2 className="card-title mb-3 ">{category.name}</h2>
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="mytextdiv colord ml-5 mr-5 ">
            <h3 className="text-center mr-3">SubCategory</h3>
