...
import { s_a, state_arr } from "../UserProfile/ManageAddress/cities";
...
function DeliveryAddressForm() {
  ...
  const [userAddress, setAddress] = useState(user?.address);
  ...
  const saveData = () => {
    axios
      .post(
        `${process.env.REACT_APP_USER_API}/${loggedInUser._id}/manageaddress`,
        {
          address: userAddress,
